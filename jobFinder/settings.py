...
SECRET_KEY = 'django-insecure-2dvj6&u0uqp!$+hxx38im1nmlnj2=iohxuby(n532%9ss=m$-a'
...
ASGI_APPLICATION = "jobFinder.asgi.application"
...
STATICFILES_DIRS = [BASE_DIR / 'jobFinder/static']

MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / 'media'

WS_TYPE = 'wss' #set 'ws' when ssl disabled or set 'wss' on ssl enabled
