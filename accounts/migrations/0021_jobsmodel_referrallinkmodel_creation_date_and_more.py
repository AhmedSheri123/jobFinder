# Generated by Django 4.2.14 on 2024-08-18 00:39
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('accounts', '0020_userprofile_referral'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, choices=[('1', 'تم التقديم'), ('2', 'مقبول'), ('3', 'التقديم مغلق')], max_length=255, null=True, verbose_name='الاذونات'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creation_date', models.DateTimeField(null=True, verbose_name='تاريخ الانشاء')),
                ('job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.jobsmodel', verbose_name='الوظيفة')),
